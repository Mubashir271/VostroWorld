...
const mapPackage = (p: any): GeneralPackageItem => ({
  id: p.id,
...
const GeneralPackages = () => {
  ...
  const [packages, setPackages] = useState<GeneralPackageItem[]>([]);
  ...
  const handleUpdate = (item: GeneralPackageItem) => {
  ...
  const handleSetActive = (item: GeneralPackageItem, active: boolean) => {
    Alert.alert(
  ...
  const handleDelete = (item: GeneralPackageItem) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        {/* ── Add / Update General Package ── */}
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>{editingId ? 'Update General Package' : 'Add General Package'}</Text>
          </View>
        ...
        {/* ── Active General Package ── */}
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Active General Package</Text>
        ...
        {/* ── Inactive General Package ── */}
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Inactive General Package</Text>
