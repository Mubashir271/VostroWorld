...
// NOT CONFIRMED LIVE — mirrors BefitAttendanceReport's caveat: `hr/sessions`
// was checked across 26k+ rows on two branches and only ever returned
// `type === 'GX'` or `'PT'`. `type === 'SPT'` below is a placeholder filter
// that will most likely return zero rows until the real SPT endpoint is
// found (e.g. from the web admin's Network tab on this exact page).
...
const CATEGORY_TYPE = 'SPT';
const SCREEN_TITLE = 'SPT Attendance Report';

const SPTAttendanceReport = () => {
...
export default SPTAttendanceReport;
