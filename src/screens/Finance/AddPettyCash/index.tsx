...
const TRANSACTIONS = [
  'Mr Arif', 'Mr Bilal', 'Mr Waqas', 'Sales Counter', 'Office Counter', 'Personal',
];
...
const AddPettyCash = () => {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      flash('Petty cash entry added successfully.');
      setAmount('');
      setType('');
      setTransaction('');
      setDescription('');
      ...
      <ScrollView contentContainerStyle={styles.body} keyboardShouldPersistTaps="handled">
        <View style={styles.card}>
          <View style={styles.titleRow}>
            <Text style={styles.cardTitle}>Add Petty Cash</Text>
            <TouchableOpacity style={styles.viewBtn} onPress={() => navigation.navigate('PettyCashLedger')}>
        ...
        <TouchableOpacity style={styles.overlay} activeOpacity={1} onPress={() => setShowTransactionPicker(false)}>
          <View style={styles.dropdownBox}>
            ...
            <ScrollView>
              {TRANSACTIONS.map(t => (
                <TouchableOpacity key={t} style={styles.dropdownItem}
                  onPress={() => { setTransaction(t); setShowTransactionPicker(false); }}>
