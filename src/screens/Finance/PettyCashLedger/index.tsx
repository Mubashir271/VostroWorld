...
import { getPettyCashLedger, deletePettyCashEntry } from '../../../api/employeeDashboard';

const TRANSACTIONS = [
  'All', 'Mr Arif', 'Mr Bilal', 'Mr Waqas', 'Sales Counter', 'Office Counter', 'Personal',
];
...
const withRunningBalance = (rows: Omit<PettyCashRow, '_debit' | '_credit' | '_balance'>[]): PettyCashRow[] => {
  let balance = 0;
  return rows.map(r => {
...
const PettyCashLedger = () => {
  ...
  const fetchLedger = useCallback(async () => {
    ...
    try {
      ...
      const res = await getPettyCashLedger(params);
  ...
  const handleDelete = async () => {
    ...
    setDeleting(true);
    try {
      await deletePettyCashEntry(deleteId);
    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.body} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.topRow}>
          <TouchableOpacity style={styles.topBtn} onPress={() => navigation.navigate('AddPettyCash')}>
            <Text style={styles.topBtnText}>Add Petty Cash</Text>
          </TouchableOpacity>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.picker} onPress={() => setShowTxPicker(true)}>
            <Text style={styles.pickerText}>{txFilter === 'All' ? 'Select Transaction' : txFilter}</Text>
        ...
        <View style={styles.card}>
          <View style={styles.tableHeader}>
            <Text style={styles.tableTitle}>Petty Cash Ledger</Text>
